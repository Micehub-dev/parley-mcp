...
| R5 | MCP handler behavior drifts away from domain contract | Medium | Medium | keep lifecycle logic in `ParleyService` and update contract spec with each change | TBD | 2026-04-03 |
