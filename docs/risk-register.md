...
| R4 | UI or packaging work distracts hardening priorities | Medium | Medium | keep packaging and UI out of the core path until the Sprint 6 MCP hardening work proves stable, and treat future surfaces as thin wrappers over the existing tools | TBD | 2026-07-03 |
...
| R6 | Diagnostic artifacts may expose raw subprocess details without redaction rules | Medium | Medium | keep diagnostics filesystem-local for now, expose them through filtered inspection tools and additive next-action hints rather than broader distribution, and add redaction policy before any external surface | TBD | 2026-07-03 |
