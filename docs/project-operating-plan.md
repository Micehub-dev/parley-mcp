...
- `parley_start`, `parley_step`, `parley_finish` end-to-end
...
- 세션 lifecycle 완성
- `parley_start`, `parley_state`, `parley_claim_lease`, `parley_finish` 안정화
- state schema 고정
- 오류 모델 정의
...
- `parley_resume`
- `parley_abort`
- `parley_release_lease`
- `parley_rewind_step`
- `parley_reconcile_state`
...
- `parley_extract_claims`
- `parley_score_consensus`
- `parley_generate_conclusion`
...
- `parley_search_threads`
- `parley_link_topics`
- `parley_list_open_questions`
...
1. `parley_step`에 실제 participant subprocess 연결
